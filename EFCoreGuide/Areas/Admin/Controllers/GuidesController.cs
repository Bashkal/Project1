...
namespace EFCoreGuide.Areas.Admin.Controllers
{
    ...
    public class GuidesController : Controller
    {
        ...
        {
            var eFCoreDbContext = _context.Guides.Include(g => g.Department);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Path,DepartmentId")] Guide guide)
        {
